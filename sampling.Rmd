...
```{r histdates, fig.width=7,fig.height=6,fig.cap="\\label{fig:histdates}Distribution of GSV dates within accessed GSV imagery"}
hist(gsvdates$OLDEST,xlab="Date",ylab="Frequency",main="")
```

Figure \ref{fig:histdates} indicates the approximate 2-year update frequency for GSV imagery.
