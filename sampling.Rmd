...
#Github repository
The python programmes used to create and train SCNN-FC-8 can be found at: 
...
kdepredict200=ptDensity(predpts.gt2011,studyarea,res=10)
kdepermits200=ptDensity(permits,studyarea,res=10)
...
plot.time=function(){
  ...
  plot.t=function(predpts,year){
    ...
    # Calculate KDE on training locations & convert to raster obj
    kde=ptDensity(predpts.gt2009,studyarea,res=10)
    return(kde*tokmsq)
  }
