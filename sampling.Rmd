...
The SQL statemetns used to refine the permits can be found here: 

##Comparing SCNN-FC-8 results to building permits
...
kderun1=ptDensity(spdo,studyarea,res=10)
kderun2=ptDensity(spdrep,studyarea,res=10)
