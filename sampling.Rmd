...
```{r kdetrain, fig.width=4,fig.height=7,fig.cap="\\label{fig:kdetrain}a)Distribution of all GSV training images; b) only training pairs that are positive for change; c) only pairs that are negative for change."}
# makeplot
...
},0.2,0.80,c(0.5,0.5))#353091.8,5027886)
par(mfg=c(2,1))
