...
#Example images
```{r examples, fig.width=8,fig.height=11}
library(imager)
#subtlechanges
...
dlist=c("F:/ottawa_image_db/45.395289,-75.734107",
        ...
        "F:/ottawa_image_db/45.364727,-75.770308",
        "F:/ottawa_image_db/45.405719,-75.726039",
        "F:/ottawa_image_db/45.362226,-75.784759",
        "F:/ottawa_image_db/45.391192,-75.745004",
        "F:/ottawa_image_db/45.348997,-75.712858",
        "F:/ottawa_image_db/45.331311,-75.790179")#,
        #"F:/ottawa_image_db/45.399765,-75.756267",
...
par(mfrow = c(10, 6), mai = c(0, .2, .2, 0))
crow=1
...
```{r}
png("./figures/examples.png",units="in",width=7,height=10,res=300)
plotexamples()
dev.off()
