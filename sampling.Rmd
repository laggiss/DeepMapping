...
```{r excludetrain, eval=TRUE, fig.width=6,fig.height=9,fig.cap="\\label{fig:excludetrain}Comparison of SCNN-FC-8 predictions (a) using all training data (b) using only training data outside of 5 neighbourhoods"}
